            ...
            <div className="w-full">
                ...
                <div className="max-w-5xl mx-auto px-6 sm:px-6 lg:px-8 mb-12">
                    <div className="bg-white w-full shadow rounded p-8 sm:p-12 -mt-72">
                        <p className="text-3xl font-bold leading-7 text-center">Login</p>
                        <form onSubmit={ handleSubmit }>
                            <div className="flex flex-col gap-4 px-0 py-4">
                                ...
                                <div className="w-full flex flex-row gap-2">
                                    ...
                                    <Link to='/signup' className="border border-blue-500 hover:bg-blue-500 hover:text-white duration-100 ease-in-out w-6/12 text-blue-500 p-2 flex flex-row justify-center items-center gap-1">
